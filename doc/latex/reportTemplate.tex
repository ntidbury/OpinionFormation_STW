...
The challenge of the simulation was to keep track of which parameters were to be varied in the society with extremists compared to the society wihtout. It was very interesting to see the change of the parameter $\mu$ in the second society compared to the first. It was further intersting to see that a variation of the interval of influence infop did not make a big difference on the result up to the point where $infop$ reaches 0.5. \\*

Further… 5.4
We could have investigated the time steps $T_{max}$ needed to get to a steady state for different sets of parameters. This would have made the build up of the simulations a little easier.
